      ...
      <header className="bg-[var(--a-surface)] border-b border-[var(--a-line)] sticky top-0 z-30">
        <div className="px-6 h-14 flex items-center gap-3">
          <button
            ...
            className="flex-1 max-w-md h-9 px-3 flex items-center gap-2 bg-[var(--a-surface-2)] border border-[var(--a-line)] rounded text-sm text-[var(--a-ink-muted)] hover:border-[var(--a-ink-faint)] transition-colors"
          >
          ...
          <div
            ...
            className="hidden md:flex items-center bg-[var(--a-surface-2)] border border-[var(--a-line)] rounded h-9 overflow-hidden text-[11px] tracking-[0.18em] font-medium"
          >
            {LOCALES.map((l) => (
              <button
                key={l}
