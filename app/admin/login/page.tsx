    ...
    <div className="min-h-screen flex flex-col px-4 py-4 relative">
      <div className="flex items-center justify-end gap-2">
        <div
          ...
          className="flex items-center bg-[var(--a-surface-2)] border border-[var(--a-line)] rounded h-9 overflow-hidden text-[11px] tracking-[0.18em] font-medium"
        >
          {LOCALES.map((l) => (
            <button
              key={l}
...
function LoginFormSkeleton() {
  return (
    <div className="bg-[var(--a-surface)] border border-[var(--a-line)] p-8 space-y-5">
      <div className="h-3 w-20 bg-[var(--a-line-soft)] rounded animate-pulse" />
      <div className="h-11 bg-[var(--a-line-soft)] rounded animate-pulse" />
      <div className="h-11 bg-[var(--a-line-soft)] rounded animate-pulse" />
    </div>
  );
}
